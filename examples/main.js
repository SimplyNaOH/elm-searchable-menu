...
var _SimplyNaOH$searchablemenu$Example$openButton = function (menuMsg) {
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('topic-container__open-button'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Add a topic'),
			_1: {ctor: '[]'}
		});
};
var _SimplyNaOH$searchablemenu$Example$advancedMenuTopicView = F3(
	function (model, isSelected, result) {
		var _p0 = result;
		var topic = _p0._1;
		var aStyle = _elm_lang$html$Html_Attributes$style(
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'color', _1: topic.color},
				_1: A2(_elm_lang$core$List$member, topic, model.otherTopics) ? {
					ctor: '::',
		...
		return {
			attributes: {
				...
				_0: _elm_lang$html$Html_Attributes$class(
					isSelected ? 'topic-menu__topic topic-menu__topic--selected' : 'topic-menu__topic'),
				_1: {ctor: '[]'}
			},
			children: {
				ctor: '::',
				_0: A2(
					...
					A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('topic-menu__matched-string'),
							_1: {ctor: '[]'}
						},
						result)),
				_1: {ctor: '[]'}
...
var _SimplyNaOH$searchablemenu$Example$exampleTopics = {
	ctor: '::',
	_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'access token', 'rgb(140,225,73)'),
	_1: {
		ctor: '::',
		_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'accumulator', 'rgb(125,40,187)'),
		_1: {
			ctor: '::',
			_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'ad-hoc polymorphism', 'rgb(35,185,243)'),
			_1: {
				ctor: '::',
				_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'add', 'rgb(162,192,219)'),
				_1: {
					ctor: '::',
					_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'adicity', 'rgb(147,207,80)'),
					_1: {
						ctor: '::',
						_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'algorithm', 'rgb(105,173,217)'),
						_1: {
							ctor: '::',
							_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'alphabet', 'rgb(182,201,176)'),
							_1: {
								ctor: '::',
								_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'amortize', 'rgb(38,7,250)'),
								_1: {
									ctor: '::',
									_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'anamorphism', 'rgb(4,100,67)'),
									_1: {
										ctor: '::',
										_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'arity', 'rgb(238,41,135)'),
										_1: {
											ctor: '::',
											_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'assert', 'rgb(24,205,224)'),
											_1: {
												ctor: '::',
												_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'bag of words', 'rgb(115,12,175)'),
												_1: {
													ctor: '::',
													_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'BC', 'rgb(56,24,117)'),
													_1: {
														ctor: '::',
														_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'beta reduce', 'rgb(93,198,97)'),
														_1: {
															ctor: '::',
															_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'bifurcation', 'rgb(235,87,153)'),
															_1: {
																ctor: '::',
																_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'bioinformatics', 'rgb(55,93,236)'),
																_1: {
																	ctor: '::',
																	_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'bisimilar', 'rgb(148,37,134)'),
																	_1: {
																		ctor: '::',
																		_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'brute force', 'rgb(171,213,236)'),
																		_1: {
																			ctor: '::',
																			_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'buffer overflow', 'rgb(211,146,126)'),
																			_1: {
																				ctor: '::',
																				_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'built-in type', 'rgb(200,210,153)'),
																				_1: {
																					ctor: '::',
																					_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'burstiness', 'rgb(143,201,157)'),
																					_1: {
																						ctor: '::',
																						_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'bursty', 'rgb(30,227,216)'),
																						_1: {
																							ctor: '::',
																							_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'cannot-link', 'rgb(204,113,222)'),
																							_1: {
																								ctor: '::',
																								_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'case dependent', 'rgb(60,195,135)'),
																								_1: {
																									ctor: '::',
																									_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'case insensitive', 'rgb(202,228,184)'),
																									_1: {
																										ctor: '::',
																										_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'case sensitive', 'rgb(170,43,136)'),
																										_1: {
																											ctor: '::',
																											_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'case-dependent', 'rgb(179,131,63)'),
																											_1: {
																												ctor: '::',
																												_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'case-sensitive', 'rgb(100,71,90)'),
																												_1: {
																													ctor: '::',
																													_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'catamorphism', 'rgb(246,92,148)'),
																													_1: {
																														ctor: '::',
																														_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'chatbot', 'rgb(222,235,212)'),
																														_1: {
																															ctor: '::',
																															_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'chunklet', 'rgb(101,167,128)'),
																															_1: {
																																ctor: '::',
																																_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'codebook', 'rgb(198,191,165)'),
																																_1: {
																																	ctor: '::',
																																	_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'combinator', 'rgb(147,157,173)'),
																																	_1: {
																																		ctor: '::',
																																		_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'combinatory logic', 'rgb(9,134,155)'),
																																		_1: {
																																			ctor: '::',
																																			_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'complexity theory', 'rgb(228,16,36)'),
																																			_1: {
																																				ctor: '::',
																																				_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'composite type', 'rgb(97,146,240)'),
																																				_1: {
																																					ctor: '::',
																																					_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'computability theory', 'rgb(115,58,107)'),
																																					_1: {
																																						ctor: '::',
																																						_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'computable function', 'rgb(157,99,141)'),
																																						_1: {
																																							ctor: '::',
																																							_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'computation history', 'rgb(175,71,101)'),
																																							_1: {
																																								ctor: '::',
																																								_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'computation tree logic', 'rgb(132,13,228)'),
																																								_1: {
																																									ctor: '::',
																																									_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'computational linguistics', 'rgb(16,211,54)'),
																																									_1: {
																																										ctor: '::',
																																										_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'computer engineering', 'rgb(9,255,200)'),
																																										_1: {
																																											ctor: '::',
																																											_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'computer science', 'rgb(124,83,14)'),
																																											_1: {
																																												ctor: '::',
																																												_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'concave function', 'rgb(10,18,196)'),
																																												_1: {
																																													ctor: '::',
																																													_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'concurrency', 'rgb(177,115,143)'),
																																													_1: {
																																														ctor: '::',
																																														_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'constraint cluster', 'rgb(47,127,2)'),
																																														_1: {
																																															ctor: '::',
																																															_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'convex function', 'rgb(78,226,246)'),
																																															_1: {
																																																ctor: '::',
																																																_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'crayon license', 'rgb(80,25,49)'),
																																																_1: {
																																																	ctor: '::',
																																																	_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'CRF', 'rgb(83,73,243)'),
																																																	_1: {
																																																		ctor: '::',
																																																		_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'data structure', 'rgb(31,130,176)'),
																																																		_1: {
																																																			ctor: '::',
																																																			_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'debug', 'rgb(162,63,97)'),
																																																			_1: {
																																																				ctor: '::',
																																																				_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'decidability', 'rgb(155,184,203)'),
																																																				_1: {
																																																					ctor: '::',
																																																					_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'decidable', 'rgb(36,243,158)'),
																																																					_1: {
																																																						ctor: '::',
																																																						_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'declarer', 'rgb(28,235,53)'),
																																																						_1: {
																																																							ctor: '::',
																																																							_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'decompile', 'rgb(88,4,87)'),
																																																							_1: {
																																																								ctor: '::',
																																																								_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'decompiler', 'rgb(57,199,88)'),
																																																								_1: {
																																																									ctor: '::',
																																																									_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'deconflict', 'rgb(110,213,209)'),
																																																									_1: {
																																																										ctor: '::',
																																																										_0: A2(_SimplyNaOH$searchablemenu$Example$Topic, 'delimiter', 'rgb(253,111,40)'),
																																																										_1: {ctor: '[]'}
																																																									}
																																																								}
																																																							}
...
var _SimplyNaOH$searchablemenu$Example$Model = F4(
	function (a, b, c, d) {
		return {topics: a, otherTopics: b, topicMenu: c, advancedMenu: d};
	});
var _SimplyNaOH$searchablemenu$Example$initialModel = A4(
	_SimplyNaOH$searchablemenu$Example$Model,
	{ctor: '[]'},
	{ctor: '[]'},
	_SimplyNaOH$searchablemenu$SearchableMenu$initialModel,
	_SimplyNaOH$searchablemenu$SearchableMenu$initialModel);
var _SimplyNaOH$searchablemenu$Example$NoOp = {ctor: 'NoOp'};
var _SimplyNaOH$searchablemenu$Example$AdvancedMenuMsg = function (a) {
	return {ctor: 'AdvancedMenuMsg', _0: a};
};
...
var _SimplyNaOH$searchablemenu$Example$update = F2(
	function (msg, model) {
		var attachCmd = F2(
			function (_p1, newCmd) {
				var _p2 = _p1;
			...
			function (name, list) {
				return _elm_lang$core$List$isEmpty(
					...
					A2(
						...
						_SimplyNaOH$searchablemenu$Example$exampleTopics)) : A2(
					_elm_lang$core$List$filter,
					function (_p5) {
						return A2(
							F2(
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Select some topics'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$map,
							_SimplyNaOH$searchablemenu$Example$TopicMenuMsg,
							A3(_SimplyNaOH$searchablemenu$SearchableMenu$view, _SimplyNaOH$searchablemenu$Example$topicMenuViewConfig, model.topicMenu, _SimplyNaOH$searchablemenu$Example$exampleTopics)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$h2,
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Select some other topics'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$map,
										_SimplyNaOH$searchablemenu$Example$AdvancedMenuMsg,
										A3(
											_SimplyNaOH$searchablemenu$SearchableMenu$view,
											_SimplyNaOH$searchablemenu$Example$advancedMenuViewConfig(model),
											model.advancedMenu,
											_SimplyNaOH$searchablemenu$Example$exampleTopics)),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _SimplyNaOH$searchablemenu$Example$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _SimplyNaOH$searchablemenu$Example$initialModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: _SimplyNaOH$searchablemenu$Example$view,
		update: _SimplyNaOH$searchablemenu$Example$update,
		subscriptions: _elm_lang$core$Basics$always(_elm_lang$core$Platform_Sub$none)
	})();

var Elm = {};
Elm['Example'] = Elm['Example'] || {};
if (typeof _SimplyNaOH$searchablemenu$Example$main !== 'undefined') {
    _SimplyNaOH$searchablemenu$Example$main(Elm['Example'], 'Example', undefined);
}
